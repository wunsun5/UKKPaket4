...
@section('container')
    <div class="row">
        ...
        <form action="/customer" method="POST" class="border rounded col-lg-10">
            @csrf
            <div class="row py-3 px-3">
                <h4 class="my-3 mb-4">Tambah Pelanggan</h4>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control mb-2" type="text" name="alamat" id="alamat" placeholder="Alamat" value="{{ old('alamat') }}" />
                    @error('alamat')
                        <div class="text-danger small ms-1">
                            {{ $message }}
                        </div>
            ...
            <button type="submit" class="btn btn-primary mb-5 mx-3 mt-1">Tambah Pelanggan</button>
        </form>
    </div>
